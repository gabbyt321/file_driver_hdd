...
#define CMPSC_ASSERT0(expr,x) logAssert(expr, __FILE__, __LINE__, x);
#define CMPSC_ASSERT1(expr,x,y) logAssert(expr, __FILE__, __LINE__, x, y);
#define CMPSC_ASSERT2(expr,x,y,z) logAssert(expr, __FILE__, __LINE__, x, y, z);
